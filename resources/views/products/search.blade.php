		...
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="colect-text ">
					...
					<a href="#">Acheter ici <i class="mdi mdi-arrow-right"></i></a>
				</div>
								...
								<div class="col-xs-9 col-sm-6 col-md-4">
									<div class="single-product " >
										<div class="product-img" >
											...
											<a href="#"><img src="{{ asset('images/'.$product->image) }}" alt="Product Title"  width="10%"/></a>
											<div class="actions-btn">
												<a href="{{ route('cart.store') }}" type="submit" value="{{ $product->id }}">
