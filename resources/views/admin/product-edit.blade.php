          ...
          <div class="col-md-responsive">
            <div class="card">
              <div class="card-header">
                ...
                <h4 class="card-title d-flex justify-content-center">Modifier un produit</h4>
              </div>
              <div class="card-body">
                <form action="/productUpdate/{{ $products->id }}" enctype="multipart/form-data" method="POST">
                  {{ csrf_field() }}
                  ...
                  <div class="form-group">
                    <b>Résumé</b>
                    <input type="text" class="form-control" name="details" id="details" value="{{ $products->details }}">
                  </div>
                  <div class="textarea-group">
                    <b>Description</b>
                    <input class="form-control" name="description" id="description" value="{{ $products->description }}">
                  </div>
                  <div class="form-group mt-5 mb-2">
                    <b>Categorie</b>
                  </div>
                    {{-- <input type="number" class="form-control" name="category_id" id="category_id" value="{{ $products->category->name }}"> --}}
                    <select name="category_id" id="category_id" value="{{ $products->category->name }}">
                  ...
                  <img src="{{ asset('/images/'.$products->image) }}" height="70px;" width="80px;">
                  <div class="input-group mt-5">
                    <b>Nouvelle image</b>
                  </div>
                  <div>
                    <input class="custum-file-input" type="file" name="image" id="image" value="{{ $products->image }}">
                  </div>
