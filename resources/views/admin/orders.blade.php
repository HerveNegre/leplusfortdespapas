          ...
          <div class="col-md-responsive">
            <div class="card">
              <div class="card-header">
                ...
                <h4 class="card-title d-flex justify-content-center"> Liste des Commandes</h4>
                @if (session('success'))
                    ...
                    <tbody>
                      @foreach ($orders as $order)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-success" href="/ordersEdit/{{ $order->id }}">MODIFIER</a>
                          </td>
                          <td>
                            <form action="/ordersDelete/{{ $order->id }}" method="post">
                              {{ csrf_field() }}
