    ...
    <div class="container">
        ...
        <div class="footer-bottom d-flex justify-content-center align-items-center flex-wrap">
            <p class="footer-text m-0">
                <b>Copyright &copy;<script>document.write(new Date().getFullYear(2020));</script> Benjamin, Quentin, Brice et Herve by Coding Academy Lyon Octobre 2020 </b><i class="fa fa-heart-o" aria-hidden="true"></i>
            </p>
        </div>
    </div>
</footer>